...
void rmatch_tests(){
    ...
    rmatch_test("The q.*ick b.*n f.*x j.*s over the lazy dog.$",text_fox,(char *[]){
    ...
    rmatch_test("T.*e q.*k b.*n f.*x j.*s o.*r t.*e l.*y d.*g.",text_fox2,(char *[]){
        "The quick brown fox jumps over the lazy dog.",
        "The quick brown fox jumps over the lazy dog.",
        "The quick brown fox jumps over the lazy dog.",
        "The quick brown fox jumps over the lazy dog.",
    ...
    rmatch_test("T.*e q.*k b.*n f.*x j.*s o.*r t.*e l[oa][az].*y d[ao]g.",text_fox3,(char *[]){
        "The quick brown fox jumps over the lazy dog.",
        NULL
    });
    /// Plus
    char *text_fox4 = "The quick brown fooox jumps over the lazy dog.";
    rmatch_test("T.*e q.*k b.*n fo+x j.*s o.*r t.*e l[oa][az].*y d[ao]g.",text_fox4,(char *[]){
        "The quick brown fooox jumps over the lazy dog.",
        NULL
    });
    rmatch_test("T.*e q.*k b.*n f.+x j.*s o.*r t.*e l[oa][az].*y d[ao]g.",text_fox4,(char *[]){
        "The quick brown fooox jumps over the lazy dog.",
        NULL
    });
    rmatch_test("T.*e q.*k b.*n f+.*x j.*s o.*r t.*e l[oa][az].*y d[ao]g.",text_fox4,(char *[]){
